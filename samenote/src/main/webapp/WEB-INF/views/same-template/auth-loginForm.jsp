...
<head>
    ...
    <meta charset="UTF-8">
    <title>SAME NOTE Login Page</title>
                                            ...
                                            <div class="card-body pt-1">
                                                <form action="login" method="post">
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <!-- 패스워드 잊어버렸을때 하는 것 -->
                                                        <div class="text-right"><a href="auth-forgot-password.jsp" class="card-link">Forgot Password?</a></div>
                                                    </div>
                                                    <!-- 회원가입으로 넘어가는 버튼 -->
                                                    <a href="auth-register.jsp" class="btn btn-outline-primary float-left btn-inline">Register</a>
                                                   	<!-- 로그인 버튼 -->
